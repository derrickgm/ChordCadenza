...
namespace ChordCadenza {
  internal abstract partial class clsPlay {
    internal abstract class clsSustain {
      ...
      internal virtual bool MidiOnDup(int pitch) {
        return false;  //no action
      }
    ...
    internal abstract class clsSustainEmu : clsSustain {
      ...
      protected virtual void SustainedOffAction() {  //Replay and CarryOver
        lock (clsPlay.KBPitchList) {
          ...
          foreach (clsPlay.clsKBPitch kbp in kbplist) {
            if (kbp.TimerActive) {  //midi ON after start of timer period (not SustainReplay)
    ...
    internal abstract class clsSustainEmuTimer : clsSustainEmu {
      ...
      internal clsSustainEmuTimer(clsSustain oldsustain) : base(oldsustain) {
    ...
    internal class clsSustainCarryOver : clsSustainEmuTimer {
    ...
    internal class clsSustainSendCtlr : clsSustainEmuTimer {
